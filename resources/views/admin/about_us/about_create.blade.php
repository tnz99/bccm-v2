                ...
                <form action="{{ url('admin/about_us') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label>Title</label>
                            <textarea type="text" name="about_title" class="form-control"></textarea>
                            @error('about_title') <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-12 mb-3">
                            <label>Description</label>
                            <div style="background-color: white">
                                <textarea name="about_description" class="form-control" rows="3" ></textarea>
                            </div>
                            @error('about_description') <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="about_image">Upload Background Image</label>
                            <div class="upload-box d-flex justify-content-center align-items-center">
                              <input type="file" id="about_image" name="about_image" class="form-control d-none" accept=".jpg,.jpeg,.png">
