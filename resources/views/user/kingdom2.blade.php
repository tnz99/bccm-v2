...
<section class="story-section gallery-wrapper">
    <div class="gallery-container">
        <div class="options">
            <div class="option">
                <div class="image @if($gallery1) bg-active @endif" style="@if($gallery1) background-image: url('{{ asset('uploads/story/kingdom/gallery/galleries/' . $gallery1->kingdom_galleries0_image ?? '') }}'); @endif">
                    <div class="label">
                        <div class="info">
                            @if($gallery1)
            ...
            <div class="option">
                <div class="image @if($gallery9) bg-active @endif" style="@if($gallery9) background-image: url('{{ asset('uploads/story/kingdom/gallery/galleries/' . $gallery9->kingdom_galleries8_image ?? '') }}'); @endif">
                    <div class="label">
                        <div class="info">
                            <div class="main">{!! nl2br(e($gallery8->kingdom_galleries8_subtitle ?? '')) !!}</div>
