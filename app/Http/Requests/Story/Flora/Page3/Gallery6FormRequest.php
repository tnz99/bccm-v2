...
class Gallery6FormRequest extends FormRequest
{
    ...
    {
        return [
            'flora_page3_gallery6_title' => [
                'required',
                'string',
                'max_words:5'
            ],
            'flora_page3_gallery6_subtitle' => [
                'required',
                'string',
                'max_words:10'
            ],
            'flora_page3_gallery6_description' => [
                'required',
            ],
            'flora_page3_gallery6_image' => [
                'nullable',
                'mimes:png,jpg,jpeg'
            ],
        ];
    ...
    {
        return [
            'flora_page3_gallery6_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'flora_page3_gallery6_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
