...
class Gallery1FormRequest extends FormRequest
{
    ...
    {
        return [
            'flora_page2_gallery1_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'flora_page2_gallery1_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
