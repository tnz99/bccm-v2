...
class Gallery4FormRequest extends FormRequest
{
    ...
    {
        return [
            'flora_page4_gallery4_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'flora_page4_gallery4_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
