...
class Gallery8FormRequest extends FormRequest
{
    ...
    {
        return [
            'flora_page4_gallery8_title' => [
                'required',
                'string',
                'max_words:3'
            ],
            'flora_page4_gallery8_subtitle' => [
                'required',
                'string',
                'max_words:10'
            ],
            'flora_page4_gallery8_description' => [
                'required',
            ],
            'flora_page4_gallery8_image' => [
                'nullable',
                'mimes:png,jpg,jpeg'
            ],
        ];
    ...
    {
        return [
            'flora_page4_gallery8_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'flora_page4_gallery8_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
