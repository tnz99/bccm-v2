...
class Gallery3FormRequest extends FormRequest
{
    ...
    {
        return [
            'flora_page5_gallery3_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'flora_page5_gallery3_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
