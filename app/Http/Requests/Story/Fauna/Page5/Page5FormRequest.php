...
class Page5FormRequest extends FormRequest
{
    ...
    {
        return [
            'fauna_page5_title_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'fauna_page5_title_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
