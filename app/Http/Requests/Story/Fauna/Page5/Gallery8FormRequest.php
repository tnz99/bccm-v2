...
class Gallery8FormRequest extends FormRequest
{
    ...
    {
        return [
            'fauna_page5_gallery8_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'fauna_page5_gallery8_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
