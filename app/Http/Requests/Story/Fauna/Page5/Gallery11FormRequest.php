...
class Gallery11FormRequest extends FormRequest
{
    ...
    {
        return [
            'fauna_page5_gallery11_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'fauna_page5_gallery11_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
