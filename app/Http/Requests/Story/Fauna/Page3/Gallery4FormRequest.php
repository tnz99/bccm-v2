...
class Gallery4FormRequest extends FormRequest
{
    ...
    {
        return [
            'fauna_page3_gallery4_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'fauna_page3_gallery4_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
