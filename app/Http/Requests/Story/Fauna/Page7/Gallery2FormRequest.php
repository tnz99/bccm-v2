...
class Gallery2FormRequest extends FormRequest
{
    ...
    {
        return [
            'fauna_page7_gallery2_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'fauna_page7_gallery2_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
