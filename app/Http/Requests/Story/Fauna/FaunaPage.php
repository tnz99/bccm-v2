...
namespace App\Http\Requests\Story\Fauna;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Facades\Validator;
class FaunaPage extends FormRequest
{
    /**
    ...
    {
        return [
            'fauna_page_title.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
