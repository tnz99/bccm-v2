...
class Gallery9FormRequest extends FormRequest
{
    ...
    {
        return [
            'fauna_page6_gallery9_title' => [
                'required',
                'string',
                'max_words:5'

            ],
            'fauna_page6_gallery9_subtitle' => [
                'required',
                'string',
                'max_words:10'
            ],
            'fauna_page6_gallery9_description' => [
                'required',
            ],
            'fauna_page6_gallery9_image' => [
                'nullable',
                'mimes:png,jpg,jpeg'
            ],
        ];
    ...
    {
        return [
            'fauna_page6_gallery9_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'fauna_page6_gallery9_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
