...
class Galleries1FormRequest extends FormRequest
{
    ...
    {
        return [
            'kingdom_galleries0_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'kingdom_galleries0_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
