...
class Galleries3FormRequest extends FormRequest
{
    ...
    {
        return [
            'kingdom_galleries2_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'kingdom_galleries2_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
