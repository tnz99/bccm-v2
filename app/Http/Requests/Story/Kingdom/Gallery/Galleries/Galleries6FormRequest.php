...
class Galleries6FormRequest extends FormRequest
{
    ...
    {
        return [
            'kingdom_galleries5_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'kingdom_galleries5_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
