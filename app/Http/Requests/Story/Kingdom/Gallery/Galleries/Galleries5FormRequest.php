...
class Galleries5FormRequest extends FormRequest
{
    ...
    {
        return [
            'kingdom_galleries4_title.max_words' => 'The :attribute may not have more than :max_words words.',
            'kingdom_galleries4_subtitle.max_words' => 'The :attribute may not have more than :max_words words.',
        ];
    }
}
